...
const config = {
  ...
  dev: {
    ...
    nPort: 80,
    mongoUri:
      "mongodb://localhost:27017/avatar",
    gmailId: "",
    gmailPassword: "",
    optTime: 60 * 15,
  ...
  prod: {
    ...
    nPort: 80,
    mongoUri:
      `mongo "mongodb://ac-l7bwl9g-shard-00-00.weurt76.mongodb.net:27017,ac-l7bwl9g-shard-00-01.weurt76.mongodb.net:27017,ac-l7bwl9g-shard-00-02.weurt76.mongodb.net:27017/myFirstDatabase?replicaSet=atlas-7fd56v-shard-0" --ssl --authenticationDatabase admin --username test --password test`,
    gmailId: "",
    gmailPassword: "",
    optTime: 60 * 15,
    expTime: 60 * 60 * 24 * 365, //365days
